...
export namespace ExpoRouter {
  type StaticRoutes = `/` | `/(main)` | `/DeskripsiButterCake` | `/DeskripsiCake` | `/DeskripsiChurros` | `/DeskripsiCookies` | `/DeskripsiCroissant` | `/DeskripsiDonat` | `/DeskripsiPancake` | `/Recipe` | `/SimpanResep` | `/_sitemap` | `/homeCake` | `/login` | `/register`;
